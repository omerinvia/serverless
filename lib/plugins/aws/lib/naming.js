...
module.exports = {
  ...
  getHttpApiApiMappingLogicalId(customDomain) {
    return `HttpApiApiMapping${this.getNormalizedResourceName(customDomain)}`;
  },
  getHttpApiDomainNameLogicalId(customDomain) {
    return `HttpApiDomainName${this.getNormalizedResourceName(customDomain)}`;
  },
  getHttpApiDomainNameIdLogicalId(customDomain) {
    return `HttpApiDomainName${this.getNormalizedResourceName(customDomain)}Id`;
  },
  getHttpApiRecordSetLogicalId(customDomain) {
    return `HttpApiRecordSet${this.getNormalizedResourceName(customDomain)}`;
  },
